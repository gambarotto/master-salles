  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "storeAdresses" ADD CONSTRAINT "UQ_9f6dee30c243dcacd3c60d992ef" UNIQUE ("storeId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "userAdresses" DROP CONSTRAINT "FK_5e7fe1e71238b40f3b97e24fbd7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "userAdresses" ALTER COLUMN "userId" SET NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "userAdresses" ADD CONSTRAINT "FK_5e7fe1e71238b40f3b97e24fbd7" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "userAdresses" ALTER COLUMN "userId" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "userAdresses" ADD CONSTRAINT "FK_5e7fe1e71238b40f3b97e24fbd7" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
